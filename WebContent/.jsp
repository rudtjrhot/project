...
<body>
		...
		<div class="row">
			<table class="table table-striped"
				...
				<tbody>
					...
					%>
					<tr>
						<td><a href="view.jsp?bno=<%=list.get(i).getBno()%>"><%=list.get(i).getBno()%></a></td>
						<td><a href="view.jsp?bno=<%=list.get(i).getBno()%>"><%=list.get(i).getBoard_title()%></a></td>
	...
	<div class="form-group" style=" width: 90%; float: left;">
		...
		<input type="text" class="form-control" placeholder="검색하기"
			name="userID" maxlength="20" style="height: 28px;">
	</div>
