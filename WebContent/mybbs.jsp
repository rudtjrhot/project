...
<body>
   ...
   %>
	...
	<div style="text-align: right; margin-right: 5%;">
		<a href="mybbssum.jsp"><button type="button"
	...
	<div class="container">
			...
			<table class="table table-striped"
               ...
               %>
					<tr style="cursor: pointer;"
						onClick="location.href='view.jsp?bno=<%=list.get(i).getBno()%>&cnt_view=<%=list.get(i).getCnt_view()%>'"
		...
		<div style="text-align: center;">
            ...
            for (int i = 1; i <= pg; i++) {
         %>
						<li><a href="mybbs.jsp?pageNumber=<%=i%>"><%=i%></a></li>
						<%
