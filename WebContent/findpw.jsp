...
$(function(){
    $("#find_pw").click(function(){
       ...
       var userEmail = $("#userEmail").val();
          ...
          type : "post",
          url : "Find_pwServlet",
          data : {"name" : userName, "email" : userEmail, "userID" : userID},      //id란 이름에 id의 값을 담음
          datatype : "json",
          success: function(data) {
        	 if(data.pw!=null)  {
            	 $("#result").text("귀하의 비밀번호는 " + data.pw + "입니다.");
             }
             else { 
			...
			<div class="jumbotron" style="padding-top: 20px;">
					...
					<div class="form-group">
						<input type="email" class="form-control" placeholder="이메일"
							name="userEmail"  id="userEmail" maxlength="20">
					</div>



					<button id="find_pw" type="button" class="btn btn-primary form-control">비밀번호 찾기</button>
					<br/>
                     <br/>
