...
<body>
	...
	<div style="text-align: right; margin-right: 5%;">
		<a href="Findbbssum.jsp?board_title=<%=board_title%>"><button type="button" class="btn btn-default"
	...
	<div class="container">
		<div class="row">
			<table class="table table-striped"
				...
				<tbody>
					...
					<%
					   ArrayList<Bbs> list = bbsDAO.getFindList(pageNumber, board_title);
		...
		<li class="dropdown"><a href="#" class="dropdown-toggle"
			...
			<ul class="dropdown-menu">
				...
				for (int i = 1; i <= pg; i++) {
			%>
				<li><a href="Findbbs.jsp?pageNumber=<%=i%>"><%=i%></a></li>
				<%
