...
<body>
	...
	<div style="text-align: right; margin-right: 6%;">
		<a href="Findbbs.jsp?board_title=<%=board_title%>"><button type="button" class="btn btn-default"
	...
	<div style="text-align: center;">
		...
		<div class="container">
			...
			<%
			ArrayList<Bbs> list = bbsDAO.getFindSumList(pageNumber, board_title);;
		...
		<div class="col-xs-12 col-sm-6 col-md-3 ">
					<div class="thumbnail" style="float: left;">
						...
						<img src="upload\<%=list.get(i).getFileRealName()%>" style="height:300px; width: 250px;">
						</a>
						<div class="caption">
		...
		<ul class="nav navbar-nav">
			<li class="dropdown"><a href="#" class="dropdown-toggle"
				...
				for (int i = 1; i <= pg; i++) {
			%>
					<li><a href="Findbbssum.jsp?pageNumber=<%=i%>"><%=i%></a></li>
					<%
